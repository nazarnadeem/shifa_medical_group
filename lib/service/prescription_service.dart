...
class PrescriptionService {
  static Future<PrescriptionModel> getPrescription(String userid) async {
    final url = AppConstant.baseUrl + 'medical_app/manage/api/prescription/all/?X-Api-Key=' + AppConstant.xApikey+'&user_id=$userid';
    try {
